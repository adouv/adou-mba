...
export default {
  ...
  config: {
    ...
    pages: ['pages/logs/main', 'pages/index/main', '^pages/exclusive/main', 'pages/drygoods/main', 'pages/drygoods/mba/main', 'pages/drygoods/mem/main', 'pages/reservation/main', 'pages/institution/main', 'pages/course/main'],
    window: {
