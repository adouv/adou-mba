...
Vue.imageUrl = Vue.prototype.$imageUrl = 'https://www.a-dou.com'
...
export default {
  ...
  config: {
    ...
    pages: [
      ...
      'pages/school/main',
      'pages/index/main',
      'pages/reservationCourseDetail/main',
      'pages/reservationActivityDetail/main',
      'pages/orderForm/main',
      '^pages/exclusive/main',
      'pages/drygoods/main',
      'pages/drygoodsMba/main',
      'pages/drygoodsMem/main',
